...
{
public static bool GetTeacherInfoByID(int? teacherID, ref int personID, ref string educationLevel, ref byte? teachingExperience, ref string certifications)
{
    bool isFound = false;
...
public static int? AddNewTeacher(int personID, string educationLevel, byte? teachingExperience, string certifications)
{
...
public static bool UpdateTeacher(int? teacherID, int personID, string educationLevel, byte? teachingExperience, string certifications)
{
    int rowAffected = 0;
