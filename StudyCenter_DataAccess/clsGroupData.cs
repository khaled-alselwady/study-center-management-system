...
namespace StudyCenter_DataAccess
{
    ...
    {
        public static bool GetGroupInfoByID(int? groupID, ref string groupName, ref int classID,
            ref int teacherID, ref int subjectGradeLevelID, ref int meetingTimeID, ref byte studentCount,
        ...
        public static int? AddNewGroup(string groupName, int classID, int teacherID, int subjectGradeLevelID, int meetingTimeID, byte studentCount, DateTime creationDate, DateTime? lastModifiedDate, bool isActive)
        {
        ...
        public static bool UpdateGroup(int? groupID, string groupName, int classID, int teacherID, int subjectGradeLevelID, int meetingTimeID, byte studentCount, DateTime creationDate, DateTime? lastModifiedDate, bool isActive)
        {
            int rowAffected = 0;
        ...
        {
            return clsDataAccessHelper.GetAll("SP_GetAllGroups");
        }
    }
}